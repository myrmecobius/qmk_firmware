...
// void tap_dance_layer(qk_tap_dance_state_t *state, void *user_data){
//     if (state->count == 1) {
//         // go to SYM
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK] = LAYOUT_5x6(
        ...
        OSM_CTL, KC_Z  , KC_X  , KC_C  , KC_D  , KC_V  ,                         KC_K  , KC_H  ,KC_COMM,KC_DOT ,KC_SLSH,KC_END ,
                           SYM, NUM,                                                             KC_LEFT_CTRL  , KC_LEFT_SHIFT  ,
                                        KC_0   ,KC_BSPC,                                 KC_3  ,
                                        KC_TAB , KC_SPC,         KC_MS_BTN2,       KC_MS_BTN3,
                                        KC_LALT, KC_ENT,                 KC_MS_BTN1
    ),
